...
| Acción | Recompensa |
|---|---|
| Compartir el enlace de invitación (1 vez por sala) | +15 🪙 |
| Ronda ganada (terminas con 0 o menos puntos) | +20 🪙 |
| Ganar la partida (total más bajo al llegar alguien a 100) | +50 🪙 |
